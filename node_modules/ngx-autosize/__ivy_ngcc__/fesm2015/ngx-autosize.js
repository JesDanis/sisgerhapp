import { Injectable, EventEmitter, Directive, ElementRef, NgZone, Input, Output, HostListener, NgModule } from '@angular/core';
...
AutosizeDirective.ɵdir = /*@__PURE__*/ ɵngcc0.ɵɵdefineDirective({ type: AutosizeDirective, selectors: [["", "autosize", ""]], hostBindings: function AutosizeDirective_HostBindings(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵlistener("input", function AutosizeDirective_input_HostBindingHandler($event) { return ctx.onInput($event.target); });
    } }, inputs: { onlyGrow: "onlyGrow", useImportant: "useImportant", minRows: "minRows", _autosize: ["autosize", "_autosize"], maxRows: "maxRows" }, outputs: { resized: "resized" }, features: [ɵngcc0.ɵɵNgOnChangesFeature] });
/** @nocollapse */
...
AutosizeModule.ɵmod = /*@__PURE__*/ ɵngcc0.ɵɵdefineNgModule({ type: AutosizeModule });
AutosizeModule.ɵinj = /*@__PURE__*/ ɵngcc0.ɵɵdefineInjector({ providers: [
        WindowRef
    ], imports: [[]] });
